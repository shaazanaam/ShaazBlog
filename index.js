...
app.get(`/posts/:id`, (req,res)=>{
  ...
  const specificIndex= posts.findIndex(((post)=>post.id===index)) 
  res.send(posts[specificIndex])
});
...
app.patch(`/posts/:id`, (req,res)=>{
  ...
  const replacementPost ={
    id: id,
    content: req.body.constent || existingPost.content,
